...
(function (_w) {
    ...
    G.Fun = {
    	...
    	CreateItem: function(time){
    		var tempDate = /clashnode/G.Fun.formatter_date(time)
    		tempDateSplit = /clashnode/tempDate.split('/');
    		var title = /clashnode/tempDateSplit[1] + '月'+ tempDateSplit[2] +'日更新，'+tempDateSplit[0]+'年最新高速Shadowrocket/SSR/V2ray/Clash订阅链接免费节点订阅';
    		var url = '/clashnode/newly-discovered-nodes/index.html?date=' + tempDate.replace(/\//g, '-');
    		var time = /clashnode/tempDateSplit[1] + '月'+ tempDateSplit[2] +'日';
